...
const WORK_TYPES = {
  base: [
    { id: "demolition", label: "Демонтаж ГКЛ/перегородок", unit: "м²", prices: [450, 650, 950] },
    { id: "garbage", label: "Вывоз мусора/погрузка", unit: "компл", prices: [17000, 25000, 37000] },
  ],
  walls: [
    { id: "plaster", label: "Шпаклёвка 2 слоя + грунтование", unit: "м²", prices: [950, 1350, 2000] },
    { id: "putty", label: "Шпаклёвка 1 слой + грунтование", unit: "м²", prices: [380, 550, 820] },
    { id: "painting", label: "Окрашивание в 2 слоя", unit: "м²", prices: [550, 800, 1200] },
    { id: "wallpaper", label: "Наклейка малярного флизелина", unit: "м²", prices: [450, 650, 970] },
    { id: "tile_walls", label: "Монтаж керамогранита на стены", unit: "м²", prices: [3500, 5000, 7500] },
    { id: "partition", label: "Монтаж перегородки ГКЛ 2 слоя", unit: "м²", prices: [2450, 3500, 5250] },
    { id: "panel", label: "Монтаж декоративной панели", unit: "м/п", prices: [1750, 2500, 3750] },
    { id: "slopes", label: "Оформление оконных откосов", unit: "м²", prices: [2100, 3000, 4500] },
  ],
  floor: [
    { id: "screed", label: "Устройство тёплого пола", unit: "компл", prices: [3500, 5000, 7500] },
    { id: "laminate", label: "Устройство ламината с подложкой", unit: "м²", prices: [730, 1050, 1570] },
    { id: "tile_floor", label: "Монтаж керамогранита на пол", unit: "м²", prices: [3500, 5000, 7500] },
    { id: "plinth", label: "Монтаж микроплинтуса", unit: "м/п", prices: [840, 1200, 1800] },
    { id: "waterproof", label: "Гидроизоляция промазочная", unit: "м²", prices: [320, 460, 690] },
  ],
  ceiling: [
    { id: "stretch", label: "Натяжной потолок (полотно+профиль)", unit: "м²", prices: [1290, 1850, 2770] },
    { id: "gypsum", label: "Монтаж багета бизон", unit: "м/п", prices: [680, 980, 1470] },
    { id: "ceiling_putty", label: "Монтаж парящего багета", unit: "м/п", prices: [1500, 2150, 3220] },
    { id: "ceiling_paint", label: "Монтаж ниши под карнизы", unit: "м/п", prices: [3150, 4500, 6750] },
    { id: "light_spot", label: "Монтаж светильника (вклейка)", unit: "шт", prices: [1430, 2050, 3070] },
    { id: "chandelier", label: "Монтаж люстры/подвесного", unit: "шт", prices: [1050, 1500, 2250] },
  ],
  electrical: [
    { id: "wiring", label: "Монтаж электропроводки (квартира)", unit: "компл", prices: [175000, 250000, 375000] },
    { id: "sockets", label: "Монтаж кондиционера", unit: "шт", prices: [17500, 25000, 37500] },
    { id: "ventilation", label: "Монтаж вытяжки с вентилятором", unit: "шт", prices: [2450, 3500, 5250] },
    { id: "light_strip", label: "Монтаж световой ленты", unit: "м/п", prices: [315, 450, 675] },
  ],
  plumbing: [
    { id: "pipes", label: "Монтаж труб (водоснабжение+канализация)", unit: "компл", prices: [84000, 120000, 180000] },
    { id: "collector", label: "Коллекторный узел (фильтры, редуктор)", unit: "компл", prices: [63700, 91000, 136500] },
    { id: "bathroom_install", label: "Монтаж акриловой ванны с экраном", unit: "компл", prices: [19740, 28200, 42300] },
    { id: "toilet", label: "Монтаж инсталляции (унитаз)", unit: "компл", prices: [8400, 12000, 18000] },
    { id: "sink", label: "Монтаж раковины со смесителем", unit: "компл", prices: [3815, 5450, 8175] },
    { id: "shower", label: "Монтаж тропического душа (стойка)", unit: "шт", prices: [5950, 8500, 12750] },
    { id: "radiators", label: "Демонтаж/монтаж радиатора", unit: "шт", prices: [2450, 3500, 5250] },
    { id: "towel_rail", label: "Монтаж полотенцесушителя эл.", unit: "шт", prices: [4550, 6500, 9750] },
    { id: "washingm", label: "Монтаж стиральной машины", unit: "шт", prices: [1813, 2590, 3885] },
  ],
};
